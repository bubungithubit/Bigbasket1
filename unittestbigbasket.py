...
class BigBasket(unittest.TestCase):
    ...
    def setUpClass(cls):
        print("start")
        cls.serv_obj = Service("C:\\Users\\malli\\Downloads\\chromedriver_win32\\chromedriver.exe")
    ...
    def test_b_Add_product_from_Best_Sellers(self):
        print("2")
        self.best_sellers = self.driver.find_element(By.XPATH,
                                                     "/html/body/div[1]/div[8]/carousel-product-widget[2]/section/div[1]/h2")
        self.driver.execute_script("arguments[0].scrollIntoView();", self.best_sellers)

    def test_c_clicAddButton(self):
        print("3")
        self.add_btn = self.driver.find_element(By.XPATH,
                                                "/html/body/div[1]/div[8]/carousel-product-widget[2]/section/div[2]/div/div[1]/div/div[1]/div/div/product-template-in-container/div[1]/div[4]/div[3]/div/div[5]/div[2]/button")
        self.add_btn.click()
        time.sleep(5)
    ...
    def test_f_hover_My_Basket(self):
        print("6")
        self.my_basket = self.driver.find_element(By.XPATH,
                                                  " //*[@id='navbar-main']/div/bigbasket-cart-template/div/div[2]/a")
        time.sleep(5)
    ...
    def test_g_assert_same_product_selected(self):
        print("7")
        self.product_name1 = self.driver.find_element(By.XPATH,
                                                      "/html/body/div[1]/div[8]/carousel-product-widget[2]/section/div[2]/div/div[1]/div/div[1]/div/div/product-template-in-container/div[1]/div[4]/div[1]/a").text
        self.ele = self.driver.find_element(By.XPATH,
                                            "//*[@id='navbar-main']/div/bigbasket-cart-template/div/div[2]/ul/li[1]/div/ul/li/div/div[3]/div/div[2]/a")
    ...
    def test_h_click_View_Basket(self):
        ...
        self.element = self.driver.find_element(By.XPATH,
                                                "//*[@id='navbar-main']/div/bigbasket-cart-template/div/div[2]/ul/li[2]/div[2]/div[2]/button")
    ...
    def test_j_screenshot(self):
        print("10")
        self.driver.get_screenshot_as_file("C:\\Screenshot\\add.png")
...
if __name__ == '__main__':
    unittest.main(testRunner=unittest.main(
        testRunner=HtmlTestRunner.HTMLTestRunner(output="C:\\Users\\malli\\PycharmProjects\\Bigbasket1\\reports")))
